...
- **Názvosloví textových stylů dle Figmy.** „Title" = `h1` titulního slidu (Semibold 120px, LH 120 %, LS 5 %); „Header 1" = `h2` obsahového slidu (Semibold 60px, LH 120 %, LS 5 %). HTML sémantika (h1/h2) se nemění, hodnoty i názvy drží Figma prezentace.
